...
fn a() {
    ...
    assert_eq!(process_data_a(indoc!("nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg")), 10);
    assert_eq!(process_data_a(indoc!("zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw")), 11);
}
...
fn b() {
    ...
    assert_eq!(process_data_b(indoc!("nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg")), 29);
    assert_eq!(process_data_b(indoc!("zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw")), 26);
}
