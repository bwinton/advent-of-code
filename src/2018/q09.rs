...
#[test]
fn a() {
    assert_eq!(process_data_a("9 players; last marble is worth 25 points"), 32);
    assert_eq!(process_data_a("10 players; last marble is worth 1618 points"), 8317);
    assert_eq!(process_data_a("13 players; last marble is worth 7999 points"), 146373);
    assert_eq!(process_data_a("17 players; last marble is worth 1104 points"), 2764);
    assert_eq!(process_data_a("21 players; last marble is worth 6111 points"), 54718);
    assert_eq!(process_data_a("30 players; last marble is worth 5807 points"), 37305);
}
